  ...
  return (
    <div className="row cw_row">
      ...
      <div className="row_thumbnails">
        {items.map((item) => {
          const isNextUp =
            item.nextUp && (!item.duration || item.currentTime === 0);
          const progress =
            !isNextUp && item.duration > 0
            ...
            >
              <div className="row_card_img">
                ...
                <div className="cw_overlay">
                  <span className="cw_remaining">
                    {isNextUp
                      ? "Kaldığınız Bölüm"
                      : `${formatTime(remaining)} kaldi`}
                  </span>
                </div>
                <div className="cw_progress_bar">
                  <div
                    className="cw_progress_fill"
